#!/usr/bin/env node
// ADR-0010: entrypoint for the pr-settlement background monitor, declared
...
// backoff, dedup), pr-settlement.mjs owns the checks. This file only
...
import { createPrSettlementAssess } from './lib/pr-settlement.mjs';

runMonitorLoop({ name: 'pr-settlement', assess: createPrSettlementAssess() }).catch(() => process.exit(0));
